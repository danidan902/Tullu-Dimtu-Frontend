  ...
  return (
              ...
              {submitSuccess ? (
                ...
                >
                  <div className="bg-white rounded-2xl shadow-xl p-6 max-w-md mx-auto border border-gray-100 transform transition-all hover:scale-[1.01]">
                    <h2 className="text-3xl font-bold text-center text-gradient bg-gradient-to-r from-indigo-600 to-purple-600 mb-6">
                        ...
                        {paymentMethods.map((method, index) => (
                          <button
                            ...
                            className={`flex items-center px-4 py-2 rounded-full transition-all ${activeMethod === index 
                              ? `bg-${method.color}-600 text-white shadow-md` 
    ...
    />
        ...
        >
          ...
          <p className="mt-2">© {new Date().getFullYear()} Tullu Dimtu Secondary School. All rights reserved.</p>
        </motion.div>
      </div>
    </div>
  );
